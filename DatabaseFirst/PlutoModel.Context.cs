...
namespace DatabaseFirst
{
    ...
    public partial class PlutoDbContext : DbContext
    {
        ...
        public virtual IQueryable<GetAuthorCoursesResult> GetAuthorCourses(Nullable<int> authorID)
        {
            var authorIDParameter = authorID.HasValue ?
                new ObjectParameter("AuthorID", authorID) :
                new ObjectParameter("AuthorID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetAuthorCoursesResult>("[PlutoDbContext].[GetAuthorCourses](@AuthorID)", authorIDParameter);
        }
